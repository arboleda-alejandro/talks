...
resource = Resource(attributes={
    SERVICE_NAME: "cncf_medellin_attendee_service_manual_instrumented"
})
...
# First API method
@get_attendees_manualinstrumented.route('/report_cncf_medellin_2024', methods=['GET'])
def report_cncf_medellin():
    event = 'cncfmedellin2024'
    with tracer.start_as_current_span("report_cncf_medellin"):
        try:
